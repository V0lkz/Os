...
static Lock mutex_lock;                         // Mutex Lock
static SpinLock spin_lock;                      // Spin Lock
static volatile uint64_t shared_counter = 0;    //  Volatile to prevent compiler optimization
